...
if (SAME_PORT) {
  ...
  server.listen(HTTP_PORT, function () {
    console.log("Tunnelmole Service listening on http://localhost:" + HTTP_PORT);
  });
} else {
  ...
  wss = new WebSocket.Server(
    ...
    () => {
      console.log("Tunnelmole Service listening on ws://localhost:" + config.server.websocketPort);
    },
  );
}
